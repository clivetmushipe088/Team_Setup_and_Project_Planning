...
| 2026-09-18 | JSON data modelling (Week 2, part 3) | Claude Code (Anthropic) | Authored the draft-07 schemas in `scripts/build/make_json.py` and wrote the generator that produces every example by querying the live database; updated `docs/sql_to_json_mapping.md` |
